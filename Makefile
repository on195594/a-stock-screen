...
demo:
	...
	@echo "==> Starting Flet Web and synthetic update worker on 127.0.0.1:8550..."
	@APP_MODE=demo STATE_DIR=.local/demo $(PYTHON) worker.py --mode demo --state-dir .local/demo & worker_pid=$$!; \
